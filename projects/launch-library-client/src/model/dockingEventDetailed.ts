 ...
 */
import { DockingLocation } from './dockingLocation';
import { SpaceStationSerializerForDockingEvent } from './spaceStationSerializerForDockingEvent';
import { SpacecraftFlightSerializerForDockingEventDetailed } from './spacecraftFlightSerializerForDockingEventDetailed';
...
export interface DockingEventDetailed { 
    ...
    docking: Date;
    departure?: Date;
    flightVehicle?: SpacecraftFlightSerializerForDockingEventDetailed;
    dockingLocation?: DockingLocation;
    spaceStation?: SpaceStationSerializerForDockingEvent;
}
