...
import { SpacecraftFlightSerializerForDockingEvent } from './spacecraftFlightSerializerForDockingEvent';
...
export interface DockingEvent { 
    ...
    docking: Date;
    departure?: Date;
    flightVehicle?: SpacecraftFlightSerializerForDockingEvent;
