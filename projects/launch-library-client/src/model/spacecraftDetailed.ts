 ...
 */
import { SpacecraftConfigurationDetail } from './spacecraftConfigurationDetail';
import { SpacecraftFlight } from './spacecraftFlight';
import { SpacecraftStatus } from './spacecraftStatus';
...
export interface SpacecraftDetailed { 
    ...
    description: string;
    spacecraftConfig?: SpacecraftConfigurationDetail;
